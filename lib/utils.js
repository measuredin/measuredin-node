...
const createRequestHandler = function(resolved, pending, matchers, exclusions, unknowns, callback) {
  // create a function which ahs local binding to the matcher, exclusion, pendings, unknowns
  return function processRequest(agent, options, data) {
